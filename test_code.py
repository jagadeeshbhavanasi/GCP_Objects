...
def create_dataset(project_id, dataset_name, dataset_location):
    ...
    dataset.location = default_dataset_location
...
def native_table_changes(project_id, dataset_name, table_name, json_schema_uri):
    ...
    for i in range(len(details['na_tables_list'])):
        ...
        if dataset_name in bq_datasets:
            ...
            if table_name not in bq_tables[dataset_name]:
                ...
                native_table_changes(project_id, dataset_name, table_name, json_schema_uri)
        else:
            ...
            try:
                ...
                dataset = create_dataset(project_id, dataset_name, default_dataset_location)
